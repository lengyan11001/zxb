...
const env = {
  ...
  llmProvider: process.env.LLM_PROVIDER || process.env.DEEPSEEK_PROVIDER || 'deepseek',
  llmApiKey: process.env.LLM_API_KEY || process.env.APIZ_API_KEY || process.env.DEEPSEEK_API_KEY || '',
  llmApiUrl: process.env.LLM_API_URL || process.env.DEEPSEEK_API_URL || 'https://api.deepseek.com/chat/completions',
  llmModel: process.env.LLM_MODEL || process.env.DEEPSEEK_MODEL || 'deepseek-chat',
  llmTimeoutMs: numberFromEnv('LLM_TIMEOUT_MS', 30_000),
